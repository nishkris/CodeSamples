...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            <h3>Fill Manager Information</h3>

            <form role='form' action='db_add_manager.php' onSubmit="return validate()" method='post'>
                ...
                <div class='form-group'>
                    ...
                    <input type='text' class='form-control' id='user' name="formManagerUser"
                           placeholder='Enter Username'>
                </div>
                <div class='form-group'>
                    <label for='password'>Password</label>
                    <input type='password' class='form-control' id='password' name="formManagerPassword"
