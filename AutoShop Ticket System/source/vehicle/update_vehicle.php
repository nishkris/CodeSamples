...
<div id="wrapper">
            ...
            if ($vinToUpdate != null) {
                ...
                if ($num > 0) {
                    ...
                    $num3 = mysql_numrows($result3);
                        ...
                        echo "<form role='form' action='db_add_vehicle.php?custId=$customerId&update=true&vin=$vinToUpdate' method='post' onSubmit='return validate()'>
    ...
    <div class='form-group'>
        ...
        <input type='text' style='width: 250px' class='form-control' id='year' name='formYear' value='$vehicleYear'>
    </div>
    <div class='form-group'>
        <label for='phone'>Mileage</label>
        <input type='text'style='width: 250px'  class='form-control' id='mileage' name='formMileage' value='$vehicleMileage'>
    </div>
    <div class='form-group'>
        <br>
        <table width='80%'>
