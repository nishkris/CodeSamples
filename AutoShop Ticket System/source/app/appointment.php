...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            ...
            $query = "select a.aid, a.date, a.time, a.vehicle, a.worker, w.name from appointment a, worker w where a.worker = w.eid";
            if (is_worker()) {
                $query .= " and w.name='" . $_SESSION["name"] . "'";
            }
            ...
            if (is_manager()) {
                ...
                echo "<table class='table'><tr><th>Vehicle</th><th>Date</th><th>Time</th><th>Worker</th>";
            }
