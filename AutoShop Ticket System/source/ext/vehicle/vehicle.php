...
<script type="text/javascript">
    ...
    function validate_delete(vin) {
        bootbox.confirm("Delete vehicle : " + vin + "?", function(result) {
            if (result) {
                window.location = 'vehicle.php?delete=' + vin;
            }
        });
    }
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            ...
            if ($customerId != null) {
                ...
                header("Location: " . $ext_context . "dash/dashboard.php");
                exit();
            }
    ...
    <a href='update_vehicle.php?vin=$vin'>edit</a>
    <a href='#' onclick=\"validate_delete('$vin')\">delete</a>
    </td>";
                echo "</tr>";
            }

            echo "</table>";
            echo "<p><a href='add_vehicle.php'>Add New Vehicle</a></p>"
            ?>
        </div>
    </div>
</div>
